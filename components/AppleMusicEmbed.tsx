  ...
  return (
    <div 
      className={`fixed transition-all duration-300 shadow-xl z-50 ${
        isExpanded 
          ? 'top-6 right-6 rounded-lg' 
          : 'top-6 right-6 w-20 h-20 rounded-full'
      }`}
      style={{
        overflow: 'hidden',
    ...
    >
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-zinc-800 to-black flex items-center justify-center">
            <div className="flex flex-col items-center">
              <svg width="30" height="20" viewBox="0 0 85 20" xmlns="http://www.w3.org/2000/svg">
      ...
      {isExpanded && (
        <div className="rounded-lg overflow-hidden shadow-2xl">
          ...
          <div className="bg-white rounded-lg" style={{ width: '280px' }}>
            {/* Header */}
            ...
            <div className="px-3 py-1 bg-white border-t border-gray-100">
              <p className="text-[10px] text-gray-500">See how your data is managed...</p>
            </div>
          </div>
        </div>
      )}
